				...
				<Col xs={2} sm={3} lg={5}>
					<div className="nav-icon">
						...
						<label htmlFor="nav-toggle" className="nav-toggle font-weight-bold mb-0">
							<span className="d-none d-sm-inline-block ml-2">All categories</span>
						</label>
						<Navbar/>
					</div>
				</Col>

				<Col xs={{span:4, offset:2}} sm={{span:6, offset:0}} lg={{span: 2, offset:0}}>
					<div className="brand">
						<Link to="/">BookStore</Link>
					</div>
				</Col>

				<Col xs={4} sm={{span:3, offset: 2}} lg={{span: 3, offset: 2}}>
